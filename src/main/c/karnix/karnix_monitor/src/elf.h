...
#define ELF_ERROR_OK			0
#define ELF_ERROR_NOT_ELF		-1
#define ELF_ERROR_NOT_32BIT		-2
#define ELF_ERROR_NOT_ARM		-3
#define ELF_ERROR_NOT_EXEC		-4
#define ELF_ERROR_TEXT_NOT_FOUND	-5
#define ELF_ERROR_TEXT_TOO_BIG		-6
#define ELF_ERROR_DATA_TOO_BIG		-7
#define ELF_ERROR_WRONG_ARGS		-99
...
#define	EM_65C816	0x101 		/* WDC 65C816 */
