...
#define MAX_NR_FUNC	31	//256	/* max nr of strings assigned to keys */
...
struct kbd_data {
	volatile char *buffer;		// the buffer
	volatile uint32_t size;	// buffer size
	volatile uint32_t *len;	// pointer to variable holding how many bytes are there
	volatile uint32_t *time;// pointer to variable holding timestamp (MTIME) of last input
	void (*k_self)(struct kbd_data* this, unsigned char value);
	void (*k_lowercase)(struct kbd_data* this, unsigned char value);
	void (*k_cur)(struct kbd_data* this, unsigned char value);
	void (*k_pad)(struct kbd_data* this, unsigned char value);
	void (*k_fn)(struct kbd_data* this, unsigned char value);
	void (*k_spec)(struct kbd_data* this, unsigned char value);
	void (*k_meta)(struct kbd_data* this, unsigned char value);
};
...
int kbd_keycode(struct kbd_data *vc, unsigned int keycode, int shift_pressed, int ctrl_pressed, int alt_pressed, char up_flag);
